...
public class portlistener : MonoBehaviour
{
    ...
    {
        Vector3 Handle_Position = Handle_Position;
        Vector3 Slider_Position = Slider_Position;
    ...
    public float sliderValue(Vector3 Handle_Position, Vector3 Slider_Position)
    {
        ...
        float end_magnitude = 160f;
        float slider_current_value = (sliderdistance - start_magnitude) / end_magnitude;
    ...
    public async void Update()
    {
        ...
        PistonOneFraction.text = PistonFractionTest.ToString();
        float TimeStep = 5f;
